...
$accountLink ='<img src="images/site/account.gif" alt="account"> <a href="/acme/accounts/"> My Account  </a>';
$navList = '<ul class="navigation">';
$navList .= '<li><a title="Menu" onclick="toggleMenu()">☰ Menu</a></li>';
...
function productEdit(){
   ...
   foreach ($products as $key => $product) {
       ...
       $pd .= "<div class='product col2'><a href='./products?action=mod&id=" . $product['invId'] . "' title='Click to modify'>Edit</a></div>";
       $pd .= "<div class='product col3'><a href='./products?action=del&id=" . $product['invId'] . "' title='Click to delete'>Delete</a></div>";
...
function buildProductsDisplay($products){
    ...
    foreach ($products as $product) {
     $pd .= '<li>';
     $pd .= "<a href='products/?action=proddetail&invId=$product[invId]&prodcat=$product[categoryId]'><img src='" . $imgpath . "$product[invThumbnail]' alt='Image of $product[invName] on Acme.com'>";
     $pd .= '<hr>';
